...
\draw (1.0605,0.5656) arc (45:315:1.5 and 0.8);
\draw (1.0605,0.5656) to[out=-28.1,in=200] (3,.6);
\draw (1.0605,-0.5656) to[out=28.1,in=160] (3,-.5);
\begin{scope}[xscale=-1,xshift=-120]
    \draw[Maroon] (1.0605,0.5656) arc (45:315:1.5 and 0.8);
\end{scope}
\end{scope}
...
\newenvironment{test}{\paragraph{Proof:}}{\hfill$\blacksquare$\vs}
