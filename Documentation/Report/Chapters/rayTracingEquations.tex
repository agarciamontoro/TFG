...
The classical equations derived from the definition of geodesic,
\[
...
In our journey to find such equations, we will find the classical Hamiltonian formulation \cite[Sec. 33.5]{thorne73}, that gives us a first order system with conserved quantities but with numerically unstable equations; this would force us to deal with the zeros of a pair of square roots.

Finally, we will be able to get rid of those square roots, simply by defining another equivalent Hamiltonian that will led us to a first order system with conserved quantities and which will be numerically-friendly \cite{thorne15}.
...
\]
which in this case reads as follows
\begin{align*}
