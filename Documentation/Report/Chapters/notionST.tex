...
The answer is the well-known result \cite{greub72}\fixme{Bad reference}.
...
\autoref{line_fields} can be generalized to obtain \cite{greub72}\fixme{Bad reference.}
