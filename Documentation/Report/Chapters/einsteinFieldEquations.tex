...
This chapter introduces some notions to lightly understand the surface of these ideas. All results and reasonings are extracted from \fixme{See pages on SachsWu} \cite[pp. ]{sachs77}.
