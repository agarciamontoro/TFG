...
\begin{definition}[Tangent vector to a manifold]
...
It is trivial to see that the directional derivative is a tangent vector to the well-known manifold $\R^n$. Having this duality \emph{directional derivative --- vector} clear, it is now natural to arrive to \autoref{def:tangentspace}
