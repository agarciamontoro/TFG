...
\begin{figure}[bth]
	\myfloatalign
	\subfloat[Top view.]
	{\frame{\includegraphics[width=.4\linewidth]{gfx/3d_01_top}}} \quad
	\subfloat[Right view.]
	{\frame{\includegraphics[width=.4\linewidth]{gfx/3d_01_right}}} \\
	\subfloat[Perspective view from behind.]
	{\frame{\includegraphics[width=.4\linewidth]{gfx/3d_01_perspective1}}} \quad
	\subfloat[Perspective view from the front side.]
	{\frame{\includegraphics[width=.4\linewidth]{gfx/3d_01_perspective2}}}
...
\begin{figure}[bth]
	\myfloatalign
	\includegraphics[width=.8\linewidth]{gfx/bh_detail_texture_disk-white}
