...
\begin{figure}[bth]
	...
	{\frame{\includegraphics[width=.4\linewidth]{gfx/bh_shadow_spin0001}}} \quad
	\subfloat[Spin = 0.25]
	{\label{fig:shadow-b}%
		\frame{\includegraphics[width=.4\linewidth]{gfx/bh_shadow_spin25}}} \\
	\subfloat[Spin = 0.75]
	{\label{fig:shadow-c}%
		\frame{\includegraphics[width=.4\linewidth]{gfx/bh_shadow_spin75}}} \quad
	\subfloat[Spin $\approx$ 1]
	{\label{fig:shadow-d}%
		\frame{\includegraphics[width=.4\linewidth]{gfx/bh_shadow_spin999}}}
...
\begin{figure}[bth]
	...
	\subfloat[Spin $\approx$ 0]
	{\label{fig:xmas-a}%
		\frame{\includegraphics[width=.4\linewidth]{gfx/bh_xmas_spin0001}}} \quad
	\subfloat[Spin = 0.25]
	{\label{fig:xmas-b}%
		\frame{\includegraphics[width=.4\linewidth]{gfx/bh_xmas_spin25}}} \\
	\subfloat[Spin = 0.75]
	{\label{fig:xmas-c}%
		\frame{\includegraphics[width=.4\linewidth]{gfx/bh_xmas_spin75}}} \quad
	\subfloat[Spin $\approx$ 1]
	{\label{fig:xmas-d}%
		\frame{\includegraphics[width=.4\linewidth]{gfx/bh_xmas_spin999}}}
...
\begin{figure}[bth]
	...
	{\label{fig:insidehalo}%
		\frame{\includegraphics[width=.45\linewidth]{gfx/disk_inside_halo}}} \quad
	\subfloat[Upper part of the inner halo.]
	{\label{fig:upperhalo}%
		\frame{\includegraphics[width=.45\linewidth]{gfx/disk_inside_halo_superior}}} \\
	\subfloat[Whole inner halo.]
	{\label{fig:wholehalo}%
		\frame{\includegraphics[width=.9\linewidth]{gfx/halo_entero}}} \quad
...
\begin{figure}[bth]
	\myfloatalign
	{\frame{\includegraphics[width=.45\linewidth]{gfx/isco1}}} \quad
	{\frame{\includegraphics[width=.45\linewidth]{gfx/isco2}}}
