...
#define __PYX_HAVE__initial_setup
#define __PYX_HAVE_API__initial_setup
#include "math.h"
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'initial_setup' */
#define __Pyx_MODULE_NAME "initial_setup"
int __pyx_module_is_main_initial_setup = 0;

/* Implementation of 'initial_setup' */
...
static void __pyx_f_13initial_setup_getCanonicalMomenta(double __pyx_v_rayTheta, double __pyx_v_rayPhi, double *__pyx_v_camBeta, double *__pyx_v_pR, double *__pyx_v_pTheta, double *__pyx_v_pPhi, double *__pyx_v_ro, double *__pyx_v_delta, double *__pyx_v_alpha, double *__pyx_v_omega, double *__pyx_v_pomega) {
  double __pyx_v_Nx;
  double __pyx_v_Ny;
  double __pyx_v_Nz;
  double __pyx_v_den;
  ...
  __Pyx_RefNannySetupContext("getCanonicalMomenta", 0);

  /* "initial_setup.pyx":46
 ...
 */
  __pyx_v_Nx = (sin(__pyx_v_rayTheta) * cos(__pyx_v_rayPhi));

  /* "initial_setup.pyx":47
 *     # the incoming ray
 *     cdef double  Nx = sin(rayTheta) * cos(rayPhi)
 *     cdef double  Ny = sin(rayTheta) * sin(rayPhi)             # <<<<<<<<<<<<<<
 *     cdef double  Nz = cos(rayTheta)
 * 
 */
  __pyx_v_Ny = (sin(__pyx_v_rayTheta) * sin(__pyx_v_rayPhi));

  /* "initial_setup.pyx":48
 *     cdef double  Nx = sin(rayTheta) * cos(rayPhi)
 *     cdef double  Ny = sin(rayTheta) * sin(rayPhi)
 *     cdef double  Nz = cos(rayTheta)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_Nz = cos(__pyx_v_rayTheta);

  /* "initial_setup.pyx":52
 *     # ********************** SET DIRECTION OF MOTION ********************** #
 ...
 */
  __pyx_v_den = (1. - ((__pyx_v_camBeta[0]) * __pyx_v_Ny));

  /* "initial_setup.pyx":55
 * 
 *     # Compute factor common to nx and nz
 ...
 */
  __pyx_v_fac = (-sqrt((1. - ((__pyx_v_camBeta[0]) * (__pyx_v_camBeta[0])))));

  /* "initial_setup.pyx":58
 * 
 *     # Compute cartesian coordinates of the direction of motion. See(A.9)
 ...
 */
  __pyx_v_nY = (((-__pyx_v_Ny) + (__pyx_v_camBeta[0])) / __pyx_v_den);

  /* "initial_setup.pyx":59
 *     # Compute cartesian coordinates of the direction of motion. See(A.9)
 *     cdef double  nY = (-Ny + camBeta[0]) / den
 *     cdef double  nX = fac * Nx / den             # <<<<<<<<<<<<<<
 *     cdef double  nZ = fac * Nz / den
 * 
 */
  __pyx_v_nX = ((__pyx_v_fac * __pyx_v_Nx) / __pyx_v_den);

  /* "initial_setup.pyx":60
 *     cdef double  nY = (-Ny + camBeta[0]) / den
 *     cdef double  nX = fac * Nx / den
 *     cdef double  nZ = fac * Nz / den             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_nZ = ((__pyx_v_fac * __pyx_v_Nz) / __pyx_v_den);

  /* "initial_setup.pyx":64
 *     # Convert the direction of motion to the FIDO's spherical orthonormal
 *     # basis. See (A.10)
 *     cdef double  nR = nX             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_E = (1. / ((__pyx_v_alpha[0]) + (((__pyx_v_omega[0]) * (__pyx_v_pomega[0])) * __pyx_v_nPhi)));

  /* "initial_setup.pyx":76
 * 
 ...
 */
  (__pyx_v_pR[0]) = (((__pyx_v_E * (__pyx_v_ro[0])) * __pyx_v_nR) / sqrt((__pyx_v_delta[0])));

  /* "initial_setup.pyx":77
 *     # Compute the canonical momenta. See (A.11)
 *     pR[0] = E * ro[0] * nR / sqrt(delta[0])
 *     pTheta[0] = E * ro[0] * nTheta             # <<<<<<<<<<<<<<
 *     pPhi[0] = E * pomega[0] * nPhi
 * 
 */
  (__pyx_v_pTheta[0]) = ((__pyx_v_E * (__pyx_v_ro[0])) * __pyx_v_nTheta);

  /* "initial_setup.pyx":78
 *     pR[0] = E * ro[0] * nR / sqrt(delta[0])
 *     pTheta[0] = E * ro[0] * nTheta
 *     pPhi[0] = E * pomega[0] * nPhi             # <<<<<<<<<<<<<<
 * 
 * 
 */
  (__pyx_v_pPhi[0]) = ((__pyx_v_E * (__pyx_v_pomega[0])) * __pyx_v_nPhi);
...
static void __pyx_f_13initial_setup_getConservedQuantities(double __pyx_v_pTheta, double __pyx_v_pPhi, double __pyx_v_theta, double __pyx_v_a, double *__pyx_v_b, double *__pyx_v_q) {
  double __pyx_v_a2;
  double __pyx_v_sinT;
  ...
  double __pyx_v_b2;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("getConservedQuantities", 0);

  /* "initial_setup.pyx":89
 *     # ********************* GET CONSERVED QUANTITIES ********************* #
 ...
 *     cdef double a2 = a*a
 */
  (__pyx_v_b[0]) = __pyx_v_pPhi;

  /* "initial_setup.pyx":91
 *     b[0] = pPhi
 * 
 *     cdef double a2 = a*a             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_b2 = (__pyx_v_pPhi * __pyx_v_pPhi);

  /* "initial_setup.pyx":102
 *     cdef double  b2 = pPhi*pPhi
 * 
 *     q[0] = pTheta2 + cosT2*((b2/sinT2) - a2)             # <<<<<<<<<<<<<<
 * 
 * 
 */
  (__pyx_v_q[0]) = (__pyx_v_pTheta2 + (__pyx_v_cosT2 * ((__pyx_v_b2 / __pyx_v_sinT2) - __pyx_v_a2)));
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initinitial_setup(void); /*proto*/
PyMODINIT_FUNC initinitial_setup(void)
#else
PyMODINIT_FUNC PyInit_initial_setup(void); /*proto*/
PyMODINIT_FUNC PyInit_initial_setup(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_initial_setup(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("initial_setup", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_initial_setup) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(1, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "initial_setup")) {
      if (unlikely(PyDict_SetItemString(modules, "initial_setup", __pyx_m) < 0)) __PYX_ERR(1, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init initial_setup", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init initial_setup");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
