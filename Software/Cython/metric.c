 ...
 */
  ...
  *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_kerr_metric.data + __pyx_t_9 * __pyx_v_kerr_metric.strides[0]) ) + __pyx_t_10 * __pyx_v_kerr_metric.strides[1]) )) = ((-2.0 * __pyx_v_pomega2) * __pyx_v_omega);
