 ...
 */
 __device__ void RK4Solve(void (*computeComponent)(int, Real, Real*, Real*, Real, Real), Real b, Real q, Real x0, Real xend, void *devInitCond, Real h,
    ...
    if(threadId < SYSTEM_SIZE){
        ...
        do{
            ...
            y1[threadId] = y0;
            __syncthreads();
            computeComponent(threadId, x0, y1, k1, b, q);
            __syncthreads();

            // K2 computation
            y1[threadId] = y0 + h*(1./5.)*k1[threadId];
            __syncthreads();
            computeComponent(threadId, x0 + (1./5.)*h, y1, k2, b, q);
            __syncthreads();
            ...
            y1[threadId] = y0 + h*((3./40.)*k1[threadId] +
                                    (9./40.)*k2[threadId]);
            __syncthreads();
            computeComponent(threadId, x0 + (3./10.)*h, y1, k3, b, q);
            __syncthreads();
            ...
            y1[threadId] = y0 + h*(  (44./45.)*k1[threadId]
                                    ...
                                    + (32./9.)*k3[threadId]);
            __syncthreads();
            computeComponent(threadId, x0 + (4./5.)*h, y1, k4, b, q);
            __syncthreads();
            ...
            y1[threadId] = y0 + h*( (19372./6561.)*k1[threadId]
                                    ...
                                    - (212./729.)*k4[threadId]);
            __syncthreads();
            computeComponent(threadId, x0 + (8./9.)*h, y1, k5, b, q);
            __syncthreads();
            ...
            __syncthreads();
            computeComponent(threadId, x0 + h, y1, k6, b, q);
            __syncthreads();
            ...
            y1[threadId] = y0 + h*((35./384.)*k1[threadId]
                                    ...
                                    + (11./84.)*k6[threadId]);
            __syncthreads();
            computeComponent(threadId, x0 + h, y1, k7, b, q);
            __syncthreads();
